  ...
  (color-theme-install
   '(color-theme-molokai
     ((foreground-color . "#F8F8F2")
      ...
      (border-color . "black")
      (cursor-color . "#009500"))
     ((curchg-default-cursor-color . "#009500")
     ...
     (font-lock-string-face ((t (:foreground "#d00000"))))
     ...
     (zjl-hl-elisp-function-call-face ((t (:foreground "#F92672"))))
     (zjl-hl-elisp-number-face ((t (:foreground "#a90000"))))
     (zjl-hl-elisp-setq-face ((t (:foreground "#FF1072"))))
     (zjl-hl-font-lock-bracket-face ((t (:foreground "#909090" :weight bold))))
     (zjl-hl-function-call-face ((t (:foreground "#00b900"))))
     (zjl-hl-local-variable-reference-face ((t (:foreground "#E6DB74"))))
     (zjl-hl-member-point-face ((t (:foreground "#a90000"))))
     (zjl-hl-member-reference-face ((t (:foreground "#f4a957"))))
     (zjl-hl-number-face ((t (:foreground "#eeeeec"))))
